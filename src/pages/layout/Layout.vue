...
<template>
  <div class="wrapper">
    ...
    <header id="top-section" class="top-text">
    ...
    <div class="parallax__layer parallax__layer--2">
      <div id="clouds" class="top-clouds" style="height:70vh">&nbsp;</div>
    </div>
...
.top-stars {
  margin-top: 0;
  height: 100vh;
  background-image: url("../images-cloud/stars-home.svg");
...
.top-clouds {
  margin-top: 0;
  height: 100vh;
  background-image: url("../images-cloud/clouds-home.svg");
...
.top-moon {
  margin-top: 0;
  height: 100vh;
  background-image: url("../images-cloud/moon-home.svg");
...
.top-trees {
  height: 100vh;
  /* background-image: url("../images-cloud/middlemarch.png"); */
...
#top-section input[type=search]:focus {
